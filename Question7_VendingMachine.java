...
public class Question7_VendingMachine {
	...
	public static void main(String[] args) {
		...
		An item in the machine can cost between 25 cents and 1 dollar, in 5-cent increments (25, 30, 35, . . . , 90, 95, or 100),
		 and the machine accepts only a single dollar bill to pay for the item.     Sample output
			Price in cents : 95
		 ...
		 * to be dispensed from a wending machine
		...
		int numberOfDimes=0;  // 10cents
		int numberOfNickles=0 ; //5cents
		
		int remainder=acceptedMoney-itemPrice; // Rest of the money
		int remainder25=0 ; // Rest of themoney after calculating the number of 25 cents 
		...
		//System.out.println("Number of 5 cents : " + numberOfNickles + "n\");
